...
myInput <- "The death of James Foley in August at the hands of Islamic State jihadists in Syria was a very public end to a hidden ordeal shared with nearly two dozen other Westerners, who were routinely beaten, starved, subjected to waterboarding and sometimes traded for cash, his freed cellmates say."

par(las=2); barplot(wordRank(myInput), col="blue", ylab="Count")
```
